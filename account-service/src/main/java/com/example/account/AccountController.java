...
public class AccountController {
    ...
    @PutMapping("/{accountNumber}/release-lock")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void releaseLock(@PathVariable String accountNumber) {
        log.info("Releasing lock for accountNumber: {}", accountNumber);
        
        try {
            accountService.releaseLock(accountNumber);
            log.info("Lock released successfully: accountNumber={}", accountNumber);
        } catch (Exception ex) {
            log.error("Failed to release lock: accountNumber={}", accountNumber, ex);
            throw ex;
        }
    }
    ...
    public void credit(@PathVariable String accountNumber,
        ...
        log.info("Crediting account: accountNumber={}, amount={}", accountNumber, request.amount());
        
        try {
            accountService.credit(accountNumber, request.amount());
            log.info("Account credited successfully: accountNumber={}, amount={}", accountNumber, request.amount());
        } catch (Exception ex) {
            log.error("Failed to credit account: accountNumber={}, amount={}", accountNumber, request.amount(), ex);
            throw ex;
        }
    }
    ...
    public void debit(@PathVariable String accountNumber,
        ...
        log.info("Debiting account: accountNumber={}, amount={}", accountNumber, request.amount());
        
        try {
            accountService.debit(accountNumber, request.amount());
            log.info("Account debited successfully: accountNumber={}, amount={}", accountNumber, request.amount());
        } catch (Exception ex) {
            log.error("Failed to debit account: accountNumber={}, amount={}", accountNumber, request.amount(), ex);
            throw ex;
        }
    }
